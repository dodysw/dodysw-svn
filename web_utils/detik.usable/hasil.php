<?
/** ---------- start file src\version.inc.php ---------- */
$app['name'] = "detik.usable";
$app['version'] = "6.0";
$app['version_description'] = <<<__END__
- clean up extraneous coding
- prepare du to be modularized/included in other php files
__END__;
/** ---------- end file src\version.inc.php ---------- */
/** ---------- start file src\define.inc.php ---------- */
/**
...
$develmode = 0;
$list_footer = '';
/** ---------- end file src\define.inc.php ---------- */
if (file_exists('config.inc.php')) include 'config.inc.php';
/** ---------- start file src\function.inc.php ---------- */
...
/** ---------- start file src\du.class.php ---------- */
/** ---------- start file src\du_sock.class.php ---------- */
class DuSock {
...
/** ---------- end file src\du_sock.class.php ---------- */
...
/** ---------- end file src\du.class.php ---------- */
/** ---------- start file src\anynews.class.php ---------- */
...
/** ---------- end file src\anynews.class.php ---------- */
if ($app['cache']) {
...
/** ---------- start file src\du_detail.page.php ---------- */
...
/** ---------- end file src\du_detail.page.php ---------- */
}
elseif ($_REQUEST['x'] == '' and $_REQUEST['anurl']) {
/** ---------- start file src\anynews_detail.page.php ---------- */
    $du = new AnyNews();
    if ($_REQUEST['cache_reload']) $du->SetSourceOrig();
    ...
    $du->GetBuffer();
    $du->Render();
/** ---------- end file src\anynews_detail.page.php ---------- */
}
elseif ($_REQUEST['x']=='i' and $_REQUEST['anurl'] != '') {
/** ---------- start file src\anynews_list.page.php ---------- */
    $du = new AnyNews();
...
/** ---------- end file src\du_list.page.php ---------- */
}
elseif ($_REQUEST['x']=='w') {
/** ---------- start file src\welcome.page.php ---------- */
foreach ($an_m as $m)
...
/** ---------- end file src\welcome.page.php ---------- */
}
elseif ($_REQUEST['x']=='s') {
    show_source(__FILE__);
}
elseif ($_REQUEST['au']) {
/** ---------- start file src\auto_update.page.php ---------- */
    if (!$_REQUEST['commit']) {
...
/** ---------- end file src\auto_update.page.php ---------- */
}
elseif ($_REQUEST['cm']) {
/** ---------- start file src\cache_clear.page.php ---------- */
...
/** ---------- end file src\cache_clear.page.php ---------- */
}
elseif ($_REQUEST['no'] == 'bcache') {
/** ---------- start file src\cache_browse.page.php ---------- */
    $display = '';
    $dh = opendir('cache');
    $cached_news = array();
    ...
    echo '<p align="center"><a href="'.$_SERVER['PHP_SELF'].'?x=w" target="m">Home &gt;</a></p>';
    show_footer();
/** ---------- end file src\cache_browse.page.php ---------- */
}
else {
/** ---------- start file src\frameset.page.php ---------- */
    echo $doctype;
?>
<html>
...
/** ---------- end file src\frameset.page.php ---------- */
}
?>
