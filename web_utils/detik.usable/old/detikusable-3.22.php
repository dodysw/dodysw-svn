...
- new pda/handphone/small screen/lynx mode for non javascript supporting web browser
- fix bug on rss feed with complete detail
- fix bug on rss feed not getting latest news
- fix bug on prev news hardcoded assumption of news count
__END__;
/*
