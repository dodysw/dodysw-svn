...
$navdata['main'] = array(
    ...
    array('media_client',lang('Client user manager'),1),
    array('upload_manager',lang('Upload manager'),1),
    #~ array('aa_detikusable',lang('Detik.Usable'),-2),

    array('',lang('News'),1),
    array('news','Berita',1),
    array('news_cat','Kategori Berita',1),
    array('news_tone','Tone',1),
    array('news_media','Media',1),
    #~ array('news_subcat','SubKategori Berita',1),
    ...
    #~ array('',lang('Project Tol Road MIS'),1),
    #~ array($subdir.'kecelakaan','Kecelakaan',1),
    );
