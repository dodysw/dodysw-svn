...
// Ver:		$Id: jpgraph_stock.php,v 2.13 2005/01/22 12:33:31 aditus Exp $
//
...
// CONSTRUCTOR
	...
	if( count($datay) % $this->iTupleSize ) {
	    JpGraphError::Raise('Data values for Stock charts must contain an even multiple of '.$this->iTupleSize.' data points. The data has '.count($datay).' data points');
	}
