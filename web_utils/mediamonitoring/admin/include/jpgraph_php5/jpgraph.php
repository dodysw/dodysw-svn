...
// Ver:		$Id: jpgraph.php,v 2.78 2005/01/22 12:33:27 aditus Exp $
//
...
if( USE_LIBRARY_GD2 === 'auto' ) {
	...
	have the required GD library. Please see the PHP documentation on how to install and enable the GD2 library.");
    }
}
else {
...
class Image {
	...
	*/
	...
	elseif($this->font_family >= _FIRST_FONT && $this->font_family <= _LAST_FONT)  {
	    ...
	    JpGraphError::Raise("Unknown font font family specification in Image::StrokeText(). [family=$this->font_family]\nTxt='$txt'");
	}
	return $boundingbox;
    }
...
class Legend {
    ...
    private $mark_abs_size=_DEFAULT_LPM_SIZE;
    private $xmargin=5,$ymargin=3,$shadow_width=2;
