...
// Ver:		$Id: jpgraph_line.php,v 2.14 2005/01/22 12:33:30 aditus Exp $
//
...
class LinePlot extends Plot{
    ...
    protected $barcenter=false;  // When we mix line and bar. Should we center the line in the bar.
...
// PUBLIC METHODS	
	...
	while( $pnts < $numpoints ) {	    
		...
		JpGraphError::Raise('LinePlot too complicated for fast line Stroke. Use standard Stroke()');
		return;
	    }
	    ++$pnts;
	} // WHILE
