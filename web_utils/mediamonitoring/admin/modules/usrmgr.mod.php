...
class usrmgr extends TableManager {
    ...
    function usrmgr() {
        ...
        $this->properties['level'] = new Prop(array('label'=>'Level','colname'=>'level','datatype'=>'int','length'=>4,'inputtype'=>'combobox','choices'=>array(0=>'Supervisor',1=>'Administrator',2=>'User level 2', 3=>'User level 3', 4=>'User level 4', 5=>'User level 5')));
        $this->properties['group'] = new Prop(array('label'=>'Group','colname'=>'group', 'length'=>25,'inputtype'=>'combobox', 'choices'=>array('admin'=>'Administrators','user'=>'Users')));
