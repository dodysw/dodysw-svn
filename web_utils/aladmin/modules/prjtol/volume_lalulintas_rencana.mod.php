...
class volume_lalulintas_rencana extends TableManager {
    var $db_table, $properties;

    function volume_lalulintas_rencana() {
        parent::TableManager(); # must call base class
		$this->_logger =& LoggerManager::getLogger('volume_laluintas_rencana');

        global $html_title;
        $this->title = 'Volume Lalu Lintas (Rencana)';
        $html_title = $this->title;
        $this->db_table = $GLOBALS['dbpre'].'volume_lalulintas_rencana_tab';
        ...
        $this->properties['volume'] = new Prop(array('label'=>'Volume (kumulatif)','colname'=>'total','datatype'=>'int','required'=>False,'is_key'=>false));
