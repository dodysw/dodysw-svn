...
class jalan_kondisi extends TableManager {
    var $db_table, $properties;

    function jalan_kondisi() {
        parent::TableManager(); # must call base class
		$this->_logger =& LoggerManager::getLogger('jalan');

        global $html_title;
        $this->title = 'Jalan: Kondisi';
        ...
        $this->properties['kode_jalan'] = new Prop(array('label'=>'Kode jalan','length'=>8,'colname'=>'kode_jalan', 'required'=>True, 'is_key'=>True,'parentkey'=>'kode_jalan'));
        ...
        #~ $this->properties['jalan'] = new Prop(array('label'=>'jalan','colname'=>'jalan','length'=>45,'required'=>True,'is_key'=>false));
