...
/** A strategy class appropriate for text:span elements
 * 
 ...
 * $Date:
 */
public class SpanStrategy extends XmlContainerStrategy {
	
	public SpanStrategy(XmlContainerElement x) {
