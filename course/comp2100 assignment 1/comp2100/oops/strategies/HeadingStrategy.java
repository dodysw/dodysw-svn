...
/** A strategy class appropriate for text:h elements
 * 
 ...
 * $Date:
 */
public class HeadingStrategy extends XmlContainerStrategy {
	
	public HeadingStrategy(XmlContainerElement x) {
