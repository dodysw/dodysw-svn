...
/* global configuration
 copyright 2004 - dody suria wijaya, dsw software house - contact: dodysw@gmail.com */
    ...
    /* FORMATTING */
    $appconf['site_title'] = 'Cisco Premier Incentive Program';
    $appconf['site_description'] = 'Program ini utk para partner Cisco, yaitu perusahaan2 yg menawarkan jasa yg
menggunakan produk2 Cisco.';

    $appconf['max_idle_time'] = 60*30;    # int, (seconds) used by auto_logout and no_double_login. to disable auto_logout, set max_idle_time to 0
    $appconf['no_double_login'] = True; # inside max_idle_time duration, the same user is not allowed to do a login, counted from user's last activity datetime.
    ...
    $GLOBALS['mail_server'] = '202.169.38.67';  # comment this to use default smtp on hosting account
    $GLOBALS['mail_from'] = 'cisco-pip@ciscopartners.interactive.web.id';  # the email address used as from: header
    $GLOBALS['mail_replyto'] = 'cisco-pip@ciscopartners.interactive.web.id';  # the email address used as replyto: header, must be entered to avoid detected as spam
    $GLOBALS['mail_to'] = 'to@gmail.com';  # the email address used as to: header
